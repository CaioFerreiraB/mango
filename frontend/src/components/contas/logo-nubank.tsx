...
/**
 * Logomarca "nu" da Nubank em prata metálica — usada só na arte do cartão Ultravioleta (o "nu"
 * invertido/prateado). Glyph inline (single-path, sem asset externo → CSP-safe/offline, como as
 * bandeiras); o brilho vem de um `linearGradient` prata escovado, com `id` único (`useId`) para não
 * colidir quando vários cartões aparecem na tela.
 */
    ...
    <svg viewBox="0 0 24 24" className={className} role="img" aria-label="Nubank">
      <defs>
        <linearGradient id={g} x1="0" y1="0" x2="0.35" y2="1">
          ...
          <stop offset="0.35" stopColor="#d3d3db" />
          <stop offset="0.6" stopColor="#ececef" />
          <stop offset="1" stopColor="#a7a7b2" />
        </linearGradient>
      </defs>
      <path
        fill={`url(#${g})`}
